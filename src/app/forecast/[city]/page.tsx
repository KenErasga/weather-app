...
export default async function ForecastPage({ params }: { params: Promise<{ city: string }> }) {
            ...
            <ul className="space-y-4">
                {result.days.map((day) => (
                    <li key={day.date}>
                        ...
                        >
                            <Image src={openWeatherConfig.iconUrl(day.icon)} alt={day.description} width={64} height={64} />
                            <div>
